...
| `ClasseVeiculo` como **tabela de propriedades** (`exigeCilindrada`, `ehPesado` + pertencimento enumerado) | **registro** de dezessete valores, cada um declarando a **natureza**; `exigeCilindrada` deriva dela, `ehPesado` morre | ADR-0031 D1/D2 |
