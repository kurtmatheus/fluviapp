...
o antigo passa a valer como história. Este índice existe para responder, sem abrir os vinte e quatro arquivos,
...
**Emendado em 2026-08-11** com a trinca da Passagem — **domínio**
([ADR-0023](0023-passagem-por-categoria-e-referencia.md)), **fronteira**
([ADR-0024](0024-fronteira-de-dados-da-passagem.md)) e **camada**
([ADR-0025](0025-camada-de-dados-da-passagem.md)) — mais a decisão de que **preço é I/O**. A trinca mexe em seis
linhas do quadro abaixo, e uma delas, o **fim do snapshot**, retira o exemplo que o critério *embutir /
referenciar / congelar* usava desde o ADR-0008.
