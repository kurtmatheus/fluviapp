...
| [painel-da-empresa.md](painel-da-empresa.md) | **aberto** · o que vem agora | Registra que a **v0.0.4 fechou o painel da plataforma** (F4 e F5) e organiza o resto: o núcleo compartilhado (Início, Rotas, Viagens) × as duas seções exclusivas da empresa (Passagens, Equipe), e a redivisão das fases — **Equipe primeiro**, porque é ela que muda a política de `(papel, cargo)` para `(papel, atuação, cargo)`. As regras deixam de ser fase e viram definição de pronto |
