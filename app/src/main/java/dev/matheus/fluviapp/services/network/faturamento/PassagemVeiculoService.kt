...
import dev.matheus.fluviapp.services.network.data.requests.faturamento.PassagemVeiculoRequest
import dev.matheus.fluviapp.services.network.data.responses.faturamento.PassagemVeiculoResponse
