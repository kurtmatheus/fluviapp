...
import dev.matheus.fluviapp.ui.components.forms.areas.porto.ContentPortoAreaForm
...
@Composable
private fun FormPortoScreenPreview() {
    FormPortoScreen(
        uiState = FormPortoUiState(
            nome = "Porto de Val-de-Cães",
            localidadeId = "1",
            localidades = listOf(LocalidadeOpcao("1", "Belém/PA")),
        )
    )
}