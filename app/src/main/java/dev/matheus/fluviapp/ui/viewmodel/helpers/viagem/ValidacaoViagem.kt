 ...
 * Empresa/navio/trechos são obrigatórios. Tarifa (ADR-0013) é opcional por acomodação (branco = não
...
data class ErrosViagem(
    ...
    val valido: Boolean
        get() = !empresa && !navio && !trechoOrigem && !trechoDestino && tarifasInvalidas.isEmpty()
}
