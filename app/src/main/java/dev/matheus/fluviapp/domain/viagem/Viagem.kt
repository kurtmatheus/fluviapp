...
data class Viagem(
    ...
    val origem: String,
    val destino: String,
    // Vínculo N-1 com Empresa/Embarcacao só por id (ADR-0008, Fase 3). Os nomes são resolvidos na fronteira
...
fun Viagem.toDocumento(): ViagemDocumento {
    // empresa/embarcacao (nomes) ficam vazios no doc de /viagens — o vínculo é por id. Os nomes só
